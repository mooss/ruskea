...
Un autre résultat remarquable est que comme pour l'anglais, le =y= est classifié avec les consonnes. Cependant, les probabilités d'observations dans l'état consonne et dans l'état voyelles pour le =y= sont plus proches en français qu'en anglais[fn:ycomp].
