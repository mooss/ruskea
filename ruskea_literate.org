...
#+BEGIN_SRC bash :tangle create_finnish_text_file.sh :shebang "#!/usr/bin/env bash" :exports code :eval never
...
#+NAME: finnishgrp
| Groupe 1                                                                          | Hors groupes | Groupe 2                                              |
|-----------------------------------------------------------------------------------|--------------|-------------------------------------------------------|
| { b,  c,  d,  f,  g,  h,  j,  k,  l,  m,  n,  p,  q,  r,  s,  t,  v,  w,  x,  z } | { å }        | { \textvisiblespace,  a,  ä,  e,  i,  o,  ö,  u,  y } |
:END:
