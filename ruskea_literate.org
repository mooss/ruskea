...
#+RESULTS:
: [[0.36550065 0.38060577 0.25389358]
:  [0.3865694  0.26883708 0.34459352]
:  [0.36905208 0.32066251 0.31028542]]
...
#+BEGIN_SRC ipython :session brownextract :results silent :tangle brownextract.py :eval never
  import nltk
  nltk.download('brown')
...
* Entrainement sur le /Brown corpus/                                 :export:
** Imports
...
#+BEGIN_SRC ipython :exports code :async yes
...
#+BEGIN_SRC ipython :tangle no :exports results
  ...
  def markov_report(markov, alphabet):
      scoretable, groups = markov_alphabetical_analysis(markov, alphabet)
  ...
  markov_report(brownmarvin, alphabet)
#+END_SRC
...
#+BEGIN_SRC ipython :tangle no :exports results
  markov_report(brownmarkov, alphabet)
#+END_SRC
